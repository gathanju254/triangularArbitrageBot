...
class RiskManager:
    ...
    def update_risk_limits(self, max_position_size: float = None, max_daily_loss: float = None, max_drawdown: float = None):
        ...
        logger.info(f"Risk limits updated: Position=${self.max_position_size}, DailyLoss=${self.max_daily_loss}, Drawdown={self.max_drawdown}%")# backend/arbitrage_bot/core/risk_manager.py
import logging
import os
from typing import Dict, List, Any
from datetime import datetime
