...
urlpatterns = [
    ...
    path('profit-history/', get_performance, name='profit_history'),
    path('stats/', get_performance, name='get_stats'),
    ...
    path('trading-config/', trading_config, name='trading-config'),
